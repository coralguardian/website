...
<section id="section-<?php echo $flexible_count; ?>"
         class="cg-section-relation cg-section section-<?php echo $bgcolor ?>">
    <div class="container">
        ...
        <?php if ($addbt == 1): ?><a href="<?php echo $btlink ?>"
                                     class="button ripple button--center <?php echo $bttype ?>"><?php echo $bttxt ?></a><?php endif; ?>
    </div>
</section>